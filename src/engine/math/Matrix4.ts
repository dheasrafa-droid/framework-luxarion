/**
 * @file Matrix4.ts
 * @description 4x4 Transformation Matrix for 3D translation, rotation, scale, perspective/orthographic projections, and camera lookAt.
 * Part of Luxarion Engine - Single Responsibility: 4x4 Transform & Projection Math.
 */
